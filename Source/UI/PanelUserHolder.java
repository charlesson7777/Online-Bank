 /*
 * PanelUserHolder.java
 * Beaudlaire Jeancharles (bmalik@bu.edu)
 * 
 * 5/8/2024
 *
 * A UI element used to contain bank clients
 */
package UI;
...
public class PanelUserHolder extends JPanel {
    ...
    public PanelUserHolder(Dimension screenSize, String name) {
    ...
    private void setTable(Dimension screenSize, String name) {
        ...
        table = new MinimalTable(screenSize, MyStrings.ACCOUNT_HOLDER_HEADERS.length, Pallete.PALE_BLUE);
        table.setHeaders(MyStrings.ACCOUNT_HOLDER_HEADERS, Pallete.PALE_BLUE, Pallete.MEDIUM_GREY, true);
        ...
        int[] colWidths = new int[] {(int)(tableWidth * 3.0 / 5.0), (int)(tableWidth * 1.0 / 5.0), (int)(tableWidth * 1.0 / 5.0)};
